    ...
    <div className='home' >
        ...
        <div className='outerservicesdiv'> 
            <div class="card-list">
                ...
                <a class="card-container" target={'_blank'} href ={"https://react-website-header-a782a166ef6d.herokuapp.com/"}><img height="200" src={ReactWebsiteHeader1} ></img>
                    <p class="reduce">
                ...
                <a class="card-container" target={'_blank'} href ={"https://react-website-header2-7aa1cc753cbd.herokuapp.com/"}><img height="200" src={ReactWebsiteHeader2} ></img>
                    <p class="reduce">
                ...
                <a class="card-container" target={'_blank'} href ={"https://react-sidebar-c9b48d6c91e3.herokuapp.com/"}><img height="200" src={ReactWebsiteSidebar1} ></img>
                    <p class="reduce">
                ...
                <a class="card-container" target={'_blank'} href ={"https://react-sidebar2-d796912b03f7.herokuapp.com/"}><img height="200" src={ReactWebsiteSidebar2} ></img>
                    <p class="reduce">
                ...
                <a class="card-container" target={'_blank'} href ={"https://boxing-news-09ce3e637120.herokuapp.com/"} >
                ...
                <a class="card-container" target={'_blank'} href ={"https://react-canvas-ba3ef7e3cbe6.herokuapp.com/"}><img height="200" src={paint} ></img>
                    <p class="reduce">
                ...
                <a class="card-container" target={'_blank'} href ={"https://bmi-calculator-website-9491fd7ea394.herokuapp.com/"}><img height="200" src={bmicalc} ></img>
                    <p class="reduce">
                ...
                <a class="card-container" target={'_blank'} href ={"https://calculator-master-79ac6e52ed8a.herokuapp.com/"}><img height="200" src={calculator} ></img>
                    <p class="reduce">
